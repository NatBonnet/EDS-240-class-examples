...
ggplot() +
  geom_point(data = penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = species), alpha = 0.5) +
  geom_point(data = penguins_summary, aes(x = mean_bill_length_mm, y = mean_bill_depth_mm, color = species), size = 5, shape = "triangle") +
...
ggplot(data = penguins, aes(x = species, fill = species)) +
  geom_bar() + # default transformation is a count summary
...
ggplot(penguin_summary, aes(x = species, y = n))+
  geom_col(stat = "identity") # map height of bars to value provided in data frame manually rather than the one computed by col()
```
...
#..........................position fill.........................
ggplot(penguins, aes(x = species, fill = island)) +
  geom_bar(position = "fill") # All the same height to compare proportions rather than values
```
